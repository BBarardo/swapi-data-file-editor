export const vehicles = [
  {
    ...
    pilots: [],
    films: ['STRING_TO_REPLACE/api/films/1/', 'STRING_TO_REPLACE/api/films/5/'],
    created: '2014-12-10T15:36:25.724000Z',
    edited: '2014-12-20T21:30:21.661000Z',
    url: 'STRING_TO_REPLACE/api/vehicles/4/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Sand Crawler.png',
  },
  {
    name: 'T-16 skyhopper',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/6/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/T-16 skyhopper.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/7/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/X-34 landspeeder.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/8/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/TIE/LN starfighter.png',
  },
  {
    name: 'Snowspeeder',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/14/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Snowspeeder.png',
  },
  {
    name: 'TIE bomber',
    model: 'TIE/sa bomber',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/16/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/TIE bomber.png',
  },
  {
    name: 'AT-AT',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/18/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/AT-AT.png',
  },
  {
    name: 'AT-ST',
    ...
    pilots: ['STRING_TO_REPLACE/api/people/13/'],
    films: ['STRING_TO_REPLACE/api/films/2/', 'STRING_TO_REPLACE/api/films/3/'],
    created: '2014-12-15T12:46:42.384000Z',
    edited: '2014-12-20T21:30:21.679000Z',
    url: 'STRING_TO_REPLACE/api/vehicles/19/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/AT-ST.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/20/',
    imageURL:
      'STRING_TO_REPLACE/images/vehicles/Storm IV Twin-Pod cloud car.png',
  },
  {
    name: 'Sail barge',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/24/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Sail barge.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/25/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Bantha-II cargo skiff.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/26/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/TIE/IN interceptor.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/30/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Imperial Speeder Bike.png',
  },
  {
    name: 'Vulture Droid',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/33/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Vulture Droid.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/34/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Multi-Troop Transport.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/35/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Armored Assault Tank.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/36/',
    imageURL:
      'STRING_TO_REPLACE/images/vehicles/Single Trooper Aerial Platform.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/37/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/C-9979 landing craft.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/38/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Tribubble bongo.png',
  },
  {
    name: 'Sith speeder',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/42/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Sith speeder.png',
  },
  {
    ...
    consumables: 'none',
    vehicle_class: 'repulsorcraft',
    pilots: ['STRING_TO_REPLACE/api/people/11/'],
    films: ['STRING_TO_REPLACE/api/films/5/'],
    created: '2014-12-20T16:24:16.026000Z',
    edited: '2014-12-20T21:30:21.714000Z',
    url: 'STRING_TO_REPLACE/api/vehicles/44/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Zephyr-G swoop bike.png',
  },
  {
    ...
    consumables: 'unknown',
    vehicle_class: 'airspeeder',
    pilots: ['STRING_TO_REPLACE/api/people/70/'],
    films: ['STRING_TO_REPLACE/api/films/5/'],
    created: '2014-12-20T17:17:33.526000Z',
    edited: '2014-12-20T21:30:21.716000Z',
    url: 'STRING_TO_REPLACE/api/vehicles/45/',
    imageURL:
      'STRING_TO_REPLACE/images/vehicles/Koro-2 Exodrive airspeeder.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/46/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/XJ-6 airspeeder.png',
  },
  {
    name: 'LAAT/i',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/50/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/LAAT/i.png',
  },
  {
    name: 'LAAT/c',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/51/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/LAAT/c.png',
  },
  {
    name: 'AT-TE',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/53/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/AT-TE.png',
  },
  {
    name: 'SPHA',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/54/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/SPHA.png',
  },
  {
    ...
    consumables: 'unknown',
    vehicle_class: 'speeder',
    pilots: ['STRING_TO_REPLACE/api/people/67/'],
    films: ['STRING_TO_REPLACE/api/films/5/'],
    created: '2014-12-20T18:15:20.312000Z',
    edited: '2014-12-20T21:30:21.735000Z',
    url: 'STRING_TO_REPLACE/api/vehicles/55/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Flitknot speeder.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/56/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Neimoidian shuttle.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/57/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Geonosian starfighter.png',
  },
  {
    ...
    pilots: ['STRING_TO_REPLACE/api/people/79/'],
    films: ['STRING_TO_REPLACE/api/films/6/'],
    created: '2014-12-20T19:43:54.870000Z',
    edited: '2014-12-20T21:30:21.745000Z',
    url: 'STRING_TO_REPLACE/api/vehicles/60/',
    imageURL:
      'STRING_TO_REPLACE/images/vehicles/Tsmeu-6 personal wheel bike.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/62/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Emergency Firespeeder.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/67/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Droid tri-fighter.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/69/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Oevvaor jet catamaran.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/70/',
    imageURL:
      'STRING_TO_REPLACE/images/vehicles/Raddaugh Gnasp fluttercraft.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/71/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Clone turbo tank.png',
  },
  {
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/72/',
    imageURL:
      'STRING_TO_REPLACE/images/vehicles/Corporate Alliance tank droid.png',
  },
  {
    name: 'Droid gunship',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/73/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/Droid gunship.png',
  },
  {
    name: 'AT-RT',
    ...
    url: 'STRING_TO_REPLACE/api/vehicles/76/',
    imageURL: 'STRING_TO_REPLACE/images/vehicles/AT-RT.png',
  },
];
